.bytecode 50.0
.class synchronized android/support/v13/app/FragmentTabHost$DummyTabFactory
...
aload 0
aload 1
putfield android/support/v13/app/FragmentTabHost$DummyTabFactory/mContext Landroid/content/Context;
return
.limit locals 2
.limit stack 2
.end method
...
dup
aload 0
getfield android/support/v13/app/FragmentTabHost$DummyTabFactory/mContext Landroid/content/Context;
