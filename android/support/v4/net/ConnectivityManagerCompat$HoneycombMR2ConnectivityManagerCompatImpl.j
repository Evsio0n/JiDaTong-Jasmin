.bytecode 50.0
.class synchronized android/support/v4/net/ConnectivityManagerCompat$HoneycombMR2ConnectivityManagerCompatImpl
...
aload 1
invokestatic android/support/v4/net/ConnectivityManagerCompatHoneycombMR2/isActiveNetworkMetered(Landroid/net/ConnectivityManager;)Z
ireturn
.limit locals 2
.limit stack 1
.end method
