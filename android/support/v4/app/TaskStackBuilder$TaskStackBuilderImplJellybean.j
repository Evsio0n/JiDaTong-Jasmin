.bytecode 50.0
.class synchronized android/support/v4/app/TaskStackBuilder$TaskStackBuilderImplJellybean
...
iload 4
aload 5
invokestatic android/support/v4/app/TaskStackBuilderJellybean/getActivitiesPendingIntent(Landroid/content/Context;I[Landroid/content/Intent;ILandroid/os/Bundle;)Landroid/app/PendingIntent;
areturn
.limit locals 6
.limit stack 6
.end method
