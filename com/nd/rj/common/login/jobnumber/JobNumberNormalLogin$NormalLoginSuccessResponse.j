.bytecode 50.0
.class public synchronized com/nd/rj/common/login/jobnumber/JobNumberNormalLogin$NormalLoginSuccessResponse
...
aload 0
getfield com/nd/rj/common/login/jobnumber/JobNumberNormalLogin$NormalLoginSuccessResponse/mSid Ljava/lang/String;
invokestatic android/text/TextUtils/isEmpty(Ljava/lang/CharSequence;)Z
ifne L0
aload 0
getfield com/nd/rj/common/login/jobnumber/JobNumberNormalLogin$NormalLoginSuccessResponse/mIdentity I
iconst_m1
if_icmpne L1
L0:
iconst_0
