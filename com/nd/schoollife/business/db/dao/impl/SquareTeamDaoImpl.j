.bytecode 50.0
.class public synchronized com/nd/schoollife/business/db/dao/impl/SquareTeamDaoImpl
.super java/lang/Object
.implements com/nd/schoollife/business/db/dao/SquareTeamDao
...
.method private bean2ContentValue(Lcom/nd/android/forumsdk/business/bean/structure/TeamInfoBean;)Landroid/content/ContentValues;
...
.signature "(Landroid/database/Cursor;)Ljava/util/List<Lcom/nd/android/forumsdk/business/bean/structure/TeamInfoBean;>;"
...
.method public cleanSquareTeam(I)Z
...
if_icmpge L0
aload 2
ldc "DELETE FROM sl_square_teams"
...
ldc "id NOT IN (SELECT id FROM sl_square_teams ORDER BY insert_time DESC LIMIT "
...
invokestatic com/nd/schoollife/business/db/dbtool/SchoolLifeDBHelper/getDB()Landroid/database/sqlite/SQLiteDatabase;
ldc "SELECT count(*) FROM sl_square_teams"
aconst_null
...
.method public getSquareTeam(I)Ljava/util/List;
.signature "(I)Ljava/util/List<Lcom/nd/android/forumsdk/business/bean/structure/TeamInfoBean;>;"
iload 1
iconst_1
if_icmpge L0
aconst_null
...
invokespecial com/nd/schoollife/business/db/dao/impl/SquareTeamDaoImpl/cursor2Bean(Landroid/database/Cursor;)Ljava/util/List;
areturn
.limit locals 2
.limit stack 11
.end method

.method public insertSquareTeam(Ljava/util/List;)J
.signature "(Ljava/util/List<Lcom/nd/android/forumsdk/business/bean/structure/TeamInfoBean;>;)J"
aload 1
ifnull L0
aload 1
...
invokevirtual com/nd/schoollife/business/db/dao/impl/SquareTeamDaoImpl/insertSquareTeamSingle(Lcom/nd/android/forumsdk/business/bean/structure/TeamInfoBean;)J
lconst_0
lcmp
ifle L4
iload 3
...
.method public insertSquareTeamSingle(Lcom/nd/android/forumsdk/business/bean/structure/TeamInfoBean;)J
aload 1
ifnonnull L0
ldc2_w -1L
lreturn
...
aload 0
aload 1
invokespecial com/nd/schoollife/business/db/dao/impl/SquareTeamDaoImpl/bean2ContentValue(Lcom/nd/android/forumsdk/business/bean/structure/TeamInfoBean;)Landroid/content/ContentValues;
ldc "id=?"
iconst_1
anewarray java/lang/String
dup
