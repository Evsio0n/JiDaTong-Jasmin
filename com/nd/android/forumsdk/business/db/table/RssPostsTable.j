.bytecode 50.0
.class public final synchronized com/nd/android/forumsdk/business/db/table/RssPostsTable
.super java/lang/Object
.implements android/provider/BaseColumns

.field public static final 'CREATE_TABLE' Ljava/lang/String; = "create table if not exists forum_rss_posts (insert_time BIGINT, active BIGINT, tid BIGINT primary key, root_tid BIGINT, unit_id BIGINT, content TEXT, article TEXT, more_content INT, title TEXT, file_info TEXT, post_time BIGINT, from_string TEXT, user_uid BIGINT, user_nickname BIGINT, user_sysavatar INT, at_uids TEXT, floor INT, praises BIGINT, praised INT, replys BIGINT, scope_id BIGINT, scope_type INT, scope_name TEXT, scope_avatar TEXT, post_info TEXT, reply_info TEXT, heat FLOAT )"
...
.field public static final 'TABLE_NAME' Ljava/lang/String; = "forum_rss_posts"
...
aload 0
ldc "create table if not exists forum_rss_posts (insert_time BIGINT, active BIGINT, tid BIGINT primary key, root_tid BIGINT, unit_id BIGINT, content TEXT, article TEXT, more_content INT, title TEXT, file_info TEXT, post_time BIGINT, from_string TEXT, user_uid BIGINT, user_nickname BIGINT, user_sysavatar INT, at_uids TEXT, floor INT, praises BIGINT, praised INT, replys BIGINT, scope_id BIGINT, scope_type INT, scope_name TEXT, scope_avatar TEXT, post_info TEXT, reply_info TEXT, heat FLOAT )"
