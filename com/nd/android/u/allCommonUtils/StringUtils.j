.bytecode 50.0
.class public synchronized com/nd/android/u/allCommonUtils/StringUtils
...
putstatic com/nd/android/u/allCommonUtils/StringUtils/userLinkMapping Ljava/util/HashMap;
ldc "@.+?\\s"
invokestatic java/util/regex/Pattern/compile(Ljava/lang/String;)Ljava/util/regex/Pattern;
putstatic com/nd/android/u/allCommonUtils/StringUtils/NAME_MATCHER Ljava/util/regex/Pattern;
ldc "#\\w+#"
invokestatic java/util/regex/Pattern/compile(Ljava/lang/String;)Ljava/util/regex/Pattern;
putstatic com/nd/android/u/allCommonUtils/StringUtils/TAG_MATCHER Ljava/util/regex/Pattern;
new com/nd/android/u/allCommonUtils/StringUtils$1
dup
invokespecial com/nd/android/u/allCommonUtils/StringUtils$1/<init>()V
putstatic com/nd/android/u/allCommonUtils/StringUtils/NAME_MATCHER_MATCH_FILTER Landroid/text/util/Linkify$MatchFilter;
new com/nd/android/u/allCommonUtils/StringUtils$2
dup
invokespecial com/nd/android/u/allCommonUtils/StringUtils$2/<init>()V
putstatic com/nd/android/u/allCommonUtils/StringUtils/NAME_MATCHER_TRANSFORM_FILTER Landroid/text/util/Linkify$TransformFilter;
new com/nd/android/u/allCommonUtils/StringUtils$3
dup
invokespecial com/nd/android/u/allCommonUtils/StringUtils$3/<init>()V
putstatic com/nd/android/u/allCommonUtils/StringUtils/TAG_MATCHER_TRANSFORM_FILTER Landroid/text/util/Linkify$TransformFilter;
return
.limit locals 0
.limit stack 2
.end method
...
getstatic com/nd/android/u/allCommonUtils/StringUtils/userLinkMapping Ljava/util/HashMap;
areturn
.limit locals 0
.limit stack 1
.end method
...
iload 3
caload
invokestatic com/nd/android/u/allCommonUtils/StringUtils/charToByte(C)B
iconst_4
ishl
aload 5
iload 3
...
aload 0
getstatic com/nd/android/u/allCommonUtils/StringUtils/TAG_MATCHER Ljava/util/regex/Pattern;
ldc "twitta://search/"
aconst_null
getstatic com/nd/android/u/allCommonUtils/StringUtils/TAG_MATCHER_TRANSFORM_FILTER Landroid/text/util/Linkify$TransformFilter;
...
aload 0
getstatic com/nd/android/u/allCommonUtils/StringUtils/NAME_MATCHER Ljava/util/regex/Pattern;
ldc "twitta://users/"
getstatic com/nd/android/u/allCommonUtils/StringUtils/NAME_MATCHER_MATCH_FILTER Landroid/text/util/Linkify$MatchFilter;
getstatic com/nd/android/u/allCommonUtils/StringUtils/NAME_MATCHER_TRANSFORM_FILTER Landroid/text/util/Linkify$TransformFilter;
invokestatic android/text/util/Linkify/addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
return
.limit locals 1
.limit stack 5
...
aload 0
invokestatic com/nd/android/u/allCommonUtils/StringUtils/isBlank(Ljava/lang/String;)Z
ifne L0
aload 1
ifnonnull L1
L0:
