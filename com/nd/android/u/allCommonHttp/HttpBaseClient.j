.bytecode 50.0
.class public synchronized com/nd/android/u/allCommonHttp/HttpBaseClient
...
aload 0
ldc ""
putfield com/nd/android/u/allCommonHttp/HttpBaseClient/sid Ljava/lang/String;
aload 0
new com/nd/android/u/allCommonHttp/HttpBaseClient$1
dup
aload 0
invokespecial com/nd/android/u/allCommonHttp/HttpBaseClient$1/<init>(Lcom/nd/android/u/allCommonHttp/HttpBaseClient;)V
putfield com/nd/android/u/allCommonHttp/HttpBaseClient/requestRetryHandler Lorg/apache/http/client/HttpRequestRetryHandler;
aload 0
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/prepareHttpClient()V
return
.limit locals 1
.limit stack 4
.end method
...
aconst_null
aload 3
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/createMethod(Ljava/lang/String;Ljava/net/URI;Lorg/json/JSONObject;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
areturn
.limit locals 4
.limit stack 5
.end method
...
aload 1
invokespecial com/nd/android/u/allCommonHttp/HttpException/<init>(Ljava/lang/String;Ljava/lang/Exception;)V
athrow
L13:
aload 3
...
aload 1
invokestatic com/nd/android/u/allCommonUtils/LogUtils/e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
new com/nd/android/u/allCommonHttp/HttpException
dup
ldc "Invalid URL."
...
aload 0
getfield com/nd/android/u/allCommonHttp/HttpBaseClient/sid Ljava/lang/String;
areturn
.limit locals 1
.limit stack 1
.end method

.method protected handleResponseStatusCode(ILcom/nd/android/u/allCommonHttp/Response;)V
...
iload 1
invokespecial com/nd/android/u/allCommonHttp/HttpException/<init>(Ljava/lang/String;I)V
athrow
L1:
new com/nd/android/u/allCommonHttp/HttpException
dup
...
athrow
L2:
new com/nd/android/u/allCommonHttp/HttpAuthException
dup
aload 2
invokevirtual com/nd/android/u/allCommonHttp/Response/asString()Ljava/lang/String;
iload 1
invokespecial com/nd/android/u/allCommonHttp/HttpAuthException/<init>(Ljava/lang/String;I)V
athrow
L3:
new com/nd/android/u/allCommonHttp/HttpServerException
dup
aload 2
invokevirtual com/nd/android/u/allCommonHttp/Response/asString()Ljava/lang/String;
iload 1
invokespecial com/nd/android/u/allCommonHttp/HttpServerException/<init>(Ljava/lang/String;I)V
athrow
L0:
return
.limit locals 3
...
.method public httpRequest(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lcom/nd/android/u/allCommonHttp/Response;
.signature "(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Lcom/nd/android/u/allCommonHttp/Response;"
.throws com/nd/android/u/allCommonHttp/HttpAuthException
.throws com/nd/android/u/allCommonHttp/HttpServerException
.throws com/nd/android/u/allCommonHttp/HttpException
aload 0
...
aload 2
aload 3
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lcom/nd/android/u/allCommonHttp/Response;
areturn
.limit locals 4
.limit stack 5
.end method

.method public httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;)Lcom/nd/android/u/allCommonHttp/Response;
.throws com/nd/android/u/allCommonHttp/HttpAuthException
.throws com/nd/android/u/allCommonHttp/HttpServerException
.throws com/nd/android/u/allCommonHttp/HttpException
aload 0
...
.method public httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/io/File;Ljava/util/ArrayList;Lorg/apache/http/client/CookieStore;)Lcom/nd/android/u/allCommonHttp/Response;
.signature "(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/io/File;Ljava/util/ArrayList<Lorg/apache/http/message/BasicNameValuePair;>;Lorg/apache/http/client/CookieStore;)Lcom/nd/android/u/allCommonHttp/Response;"
.throws com/nd/android/u/allCommonHttp/HttpAuthException
.throws com/nd/android/u/allCommonHttp/HttpServerException
.throws com/nd/android/u/allCommonHttp/HttpException
aload 0
...
.method public httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lcom/nd/android/u/allCommonHttp/Response;
.signature "(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Lcom/nd/android/u/allCommonHttp/Response;"
.throws com/nd/android/u/allCommonHttp/HttpAuthException
.throws com/nd/android/u/allCommonHttp/HttpServerException
.throws com/nd/android/u/allCommonHttp/HttpException
...
aload 0
aload 1
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/createURI(Ljava/lang/String;)Ljava/net/URI;
astore 6
aconst_null
astore 1
aconst_null
...
aload 0
aload 2
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/setupHTTPConnectionParams(Lorg/apache/http/client/methods/HttpUriRequest;)V
L0:
aload 0
getfield com/nd/android/u/allCommonHttp/HttpBaseClient/mClient Lorg/apache/http/impl/client/DefaultHttpClient;
aload 2
aload 0
getfield com/nd/android/u/allCommonHttp/HttpBaseClient/localcontext Lorg/apache/http/protocol/BasicHttpContext;
...
astore 1
L6:
new com/nd/android/u/allCommonHttp/Response
dup
aload 2
invokespecial com/nd/android/u/allCommonHttp/Response/<init>(Lorg/apache/http/HttpResponse;)V
astore 3
L7:
aload 3
astore 1
...
aload 2
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/handleResponseStatusCode(ILcom/nd/android/u/allCommonHttp/Response;)V
aload 2
areturn
L2:
astore 1
...
.method public httpRequest(Ljava/lang/String;[BLorg/json/JSONObject;Ljava/lang/String;)Lcom/nd/android/u/allCommonHttp/Response;
.throws com/nd/android/u/allCommonHttp/HttpAuthException
.throws com/nd/android/u/allCommonHttp/HttpServerException
.throws com/nd/android/u/allCommonHttp/HttpException
.catch java/net/SocketTimeoutException from L0 to L1 using L2
...
aload 5
aload 2
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/createMethod(Ljava/lang/String;Ljava/net/URI;[B)Lorg/apache/http/client/methods/HttpUriRequest;
astore 2
aload 0
aload 2
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/setupHTTPConnectionParams(Lorg/apache/http/client/methods/HttpUriRequest;)V
...
.method public httpUpImageRequest(Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;)Lcom/nd/android/u/allCommonHttp/Response;
.throws com/nd/android/u/allCommonHttp/HttpAuthException
.throws com/nd/android/u/allCommonHttp/HttpServerException
.throws com/nd/android/u/allCommonHttp/HttpException
...
aload 4
invokevirtual java/io/ByteArrayOutputStream/toByteArray()[B
invokestatic com/nd/android/u/allCommonUtils/MD5ArithmeticUtils/getMD5OfBytes([B)Ljava/lang/String;
invokespecial org/apache/http/entity/mime/content/StringBody/<init>(Ljava/lang/String;)V
invokevirtual org/apache/http/entity/mime/MultipartEntity/addPart(Ljava/lang/String;Lorg/apache/http/entity/mime/content/ContentBody;)V
L1:
aload 4
...
aload 2
aload 5
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/createMethod(Ljava/lang/String;Ljava/net/URI;Lorg/apache/http/entity/mime/MultipartEntity;)Lorg/apache/http/client/methods/HttpUriRequest;
astore 2
aload 0
aload 2
invokevirtual com/nd/android/u/allCommonHttp/HttpBaseClient/setupHTTPConnectionParams(Lorg/apache/http/client/methods/HttpUriRequest;)V
...
new com/nd/android/u/allCommonHttp/SSLSocketFactoryEx
dup
aload 1
invokespecial com/nd/android/u/allCommonHttp/SSLSocketFactoryEx/<init>(Ljava/security/KeyStore;)V
astore 1
aload 1
...
putfield com/nd/android/u/allCommonHttp/HttpBaseClient/mClient Lorg/apache/http/impl/client/DefaultHttpClient;
L1:
return
L2:
astore 1
