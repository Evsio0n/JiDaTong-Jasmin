.bytecode 50.0
.class public synchronized com/nd/android/u/allCommonHttp/Response
...
aload 0
aconst_null
putfield com/nd/android/u/allCommonHttp/Response/mResponse Lorg/apache/http/HttpResponse;
aload 0
iconst_0
putfield com/nd/android/u/allCommonHttp/Response/mStreamConsumed Z
aload 0
aload 1
putfield com/nd/android/u/allCommonHttp/Response/mResponse Lorg/apache/http/HttpResponse;
return
...
aload 0
getfield com/nd/android/u/allCommonHttp/Response/mResponse Lorg/apache/http/HttpResponse;
...
.throws com/nd/android/u/allCommonHttp/ResponseException
...
L2:
astore 1
new com/nd/android/u/allCommonHttp/ResponseException
dup
new java/lang/StringBuilder
dup
aload 1
...
invokevirtual java/lang/StringBuilder/toString()Ljava/lang/String;
aload 1
invokespecial com/nd/android/u/allCommonHttp/ResponseException/<init>(Ljava/lang/String;Ljava/lang/Exception;)V
athrow
L3:
astore 1
new com/nd/android/u/allCommonHttp/ResponseException
...
aload 0
aload 1
invokevirtual com/nd/android/u/allCommonHttp/Response/asString(Ljava/lang/String;)Ljava/lang/String;
astore 1
aload 1
ifnonnull L0
aconst_null
...
.catch java/lang/NullPointerException from L18 to L19 using L2
.catch java/io/IOException from L18 to L19 using L3
.catch all from L18 to L19 using L4
.catch all from L20 to L4 using L4
.catch java/io/IOException from L21 to L22 using L23
.catch all from L24 to L23 using L4
aload 0
invokevirtual com/nd/android/u/allCommonHttp/Response/asStream()Ljava/io/InputStream;
astore 5
aload 5
ifnonnull L25
aconst_null
...
aload 0
iconst_1
invokespecial com/nd/android/u/allCommonHttp/Response/setStreamConsumed(Z)V
aload 5
...
aload 0
getfield com/nd/android/u/allCommonHttp/Response/mStreamConsumed Z
ireturn
.limit locals 1
.limit stack 1
.end method
