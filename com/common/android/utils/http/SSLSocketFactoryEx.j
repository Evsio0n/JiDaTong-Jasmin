.bytecode 50.0
.class public synchronized com/common/android/utils/http/SSLSocketFactoryEx
.super org/apache/http/conn/ssl/SSLSocketFactory
.inner class inner com/common/android/utils/http/SSLSocketFactoryEx$1
...
putfield com/common/android/utils/http/SSLSocketFactoryEx/sslContext Ljavax/net/ssl/SSLContext;
new com/common/android/utils/http/SSLSocketFactoryEx$1
dup
aload 0
invokespecial com/common/android/utils/http/SSLSocketFactoryEx$1/<init>(Lcom/common/android/utils/http/SSLSocketFactoryEx;)V
astore 1
aload 0
getfield com/common/android/utils/http/SSLSocketFactoryEx/sslContext Ljavax/net/ssl/SSLContext;
aconst_null
iconst_1
