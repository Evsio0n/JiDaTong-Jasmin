.bytecode 50.0
.class public synchronized com/common/android/utils/http/HttpBaseClient
...
aload 0
ldc ""
putfield com/common/android/utils/http/HttpBaseClient/sid Ljava/lang/String;
aload 0
new com/common/android/utils/http/HttpBaseClient$1
dup
aload 0
invokespecial com/common/android/utils/http/HttpBaseClient$1/<init>(Lcom/common/android/utils/http/HttpBaseClient;)V
putfield com/common/android/utils/http/HttpBaseClient/requestRetryHandler Lorg/apache/http/client/HttpRequestRetryHandler;
aload 0
iconst_1
invokevirtual com/common/android/utils/http/HttpBaseClient/prepareHttpClient(Z)V
return
.limit locals 1
.limit stack 4
.end method
...
getstatic com/nd/android/u/allcommon/R$string/service_success_no_data I
...
getfield com/product/android/business/ApplicationVariable/applicationContext Landroid/content/Context;
invokevirtual android/content/Context/getResources()Landroid/content/res/Resources;
getstatic com/nd/android/u/allcommon/R$string/json_error_400 I
invokevirtual android/content/res/Resources/getString(I)Ljava/lang/String;
astore 1
goto L6
L2:
...
getfield com/product/android/business/ApplicationVariable/applicationContext Landroid/content/Context;
invokevirtual android/content/Context/getResources()Landroid/content/res/Resources;
getstatic com/nd/android/u/allcommon/R$string/no_request_auth I
invokevirtual android/content/res/Resources/getString(I)Ljava/lang/String;
astore 1
goto L6
L3:
...
getfield com/product/android/business/ApplicationVariable/applicationContext Landroid/content/Context;
invokevirtual android/content/Context/getResources()Landroid/content/res/Resources;
getstatic com/nd/android/u/allcommon/R$string/no_request_method I
invokevirtual android/content/res/Resources/getString(I)Ljava/lang/String;
astore 1
goto L6
L4:
...
getfield com/product/android/business/ApplicationVariable/applicationContext Landroid/content/Context;
invokevirtual android/content/Context/getResources()Landroid/content/res/Resources;
getstatic com/nd/android/u/allcommon/R$string/no_impl I
invokevirtual android/content/res/Resources/getString(I)Ljava/lang/String;
astore 1
goto L6
.limit locals 2
...
aconst_null
aload 3
invokevirtual com/common/android/utils/http/HttpBaseClient/createMethod(Ljava/lang/String;Ljava/net/URI;Lorg/json/JSONObject;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
areturn
.limit locals 4
.limit stack 5
.end method
...
aload 1
invokespecial com/common/android/utils/http/HttpException/<init>(Ljava/lang/String;Ljava/lang/Exception;)V
athrow
L3:
...
invokevirtual java/lang/String/equals(Ljava/lang/Object;)Z
ifeq L19
new com/common/android/utils/http/HttpPatch
dup
aload 2
invokespecial com/common/android/utils/http/HttpPatch/<init>(Ljava/net/URI;)V
astore 1
aload 3
ifnull L12
L11:
...
aload 1
aload 2
invokevirtual com/common/android/utils/http/HttpPatch/setEntity(Lorg/apache/http/HttpEntity;)V
L12:
aload 1
areturn
L13:
...
aload 0
getfield com/common/android/utils/http/HttpBaseClient/sid Ljava/lang/String;
areturn
.limit locals 1
.limit stack 1
.end method

.method protected handleResponseStatusCode(ILcom/common/android/utils/http/Response;)V
...
athrow
L2:
new com/common/android/utils/http/HttpAuthException
dup
aload 2
invokevirtual com/common/android/utils/http/Response/asString()Ljava/lang/String;
iload 1
invokespecial com/common/android/utils/http/HttpAuthException/<init>(Ljava/lang/String;I)V
athrow
L3:
new com/common/android/utils/http/HttpServerException
dup
aload 2
invokevirtual com/common/android/utils/http/Response/asString()Ljava/lang/String;
iload 1
invokespecial com/common/android/utils/http/HttpServerException/<init>(Ljava/lang/String;I)V
athrow
L0:
return
.limit locals 3
...
.method public httpRequest(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lcom/common/android/utils/http/Response;
.signature "(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Lcom/common/android/utils/http/Response;"
.throws com/common/android/utils/http/HttpAuthException
.throws com/common/android/utils/http/HttpServerException
.throws com/common/android/utils/http/HttpException
aload 0
...
aload 2
aload 3
invokevirtual com/common/android/utils/http/HttpBaseClient/httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lcom/common/android/utils/http/Response;
areturn
.limit locals 4
.limit stack 5
.end method

.method public httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;)Lcom/common/android/utils/http/Response;
.throws com/common/android/utils/http/HttpAuthException
.throws com/common/android/utils/http/HttpServerException
.throws com/common/android/utils/http/HttpException
aload 0
...
.method public httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/io/File;Ljava/util/ArrayList;Lorg/apache/http/client/CookieStore;)Lcom/common/android/utils/http/Response;
.signature "(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/io/File;Ljava/util/ArrayList<Lorg/apache/http/message/BasicNameValuePair;>;Lorg/apache/http/client/CookieStore;)Lcom/common/android/utils/http/Response;"
.throws com/common/android/utils/http/HttpAuthException
.throws com/common/android/utils/http/HttpServerException
.throws com/common/android/utils/http/HttpException
aload 0
...
.method public httpRequest(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;)Lcom/common/android/utils/http/Response;
.signature "(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Lcom/common/android/utils/http/Response;"
.throws com/common/android/utils/http/HttpAuthException
.throws com/common/android/utils/http/HttpServerException
.throws com/common/android/utils/http/HttpException
...
aload 0
aload 1
invokevirtual com/common/android/utils/http/HttpBaseClient/createURI(Ljava/lang/String;)Ljava/net/URI;
astore 6
aconst_null
astore 1
aconst_null
...
aload 0
aload 2
invokevirtual com/common/android/utils/http/HttpBaseClient/setupHTTPConnectionParams(Lorg/apache/http/client/methods/HttpUriRequest;)V
L0:
aload 0
getfield com/common/android/utils/http/HttpBaseClient/mClient Lorg/apache/http/impl/client/DefaultHttpClient;
aload 2
aload 0
getfield com/common/android/utils/http/HttpBaseClient/localcontext Lorg/apache/http/protocol/BasicHttpContext;
...
astore 1
L6:
new com/common/android/utils/http/Response
dup
aload 2
invokespecial com/common/android/utils/http/Response/<init>(Lorg/apache/http/HttpResponse;)V
astore 3
L7:
aload 3
astore 1
...
aload 2
invokevirtual com/common/android/utils/http/HttpBaseClient/handleResponseStatusCode(ILcom/common/android/utils/http/Response;)V
aload 2
areturn
L2:
astore 1
...
.method public httpRequest(Ljava/lang/String;[BLorg/json/JSONObject;Ljava/lang/String;)Lcom/common/android/utils/http/Response;
.throws com/common/android/utils/http/HttpAuthException
.throws com/common/android/utils/http/HttpServerException
.throws com/common/android/utils/http/HttpException
.catch java/net/SocketTimeoutException from L0 to L1 using L2
...
aload 5
aload 2
invokevirtual com/common/android/utils/http/HttpBaseClient/createMethod(Ljava/lang/String;Ljava/net/URI;[B)Lorg/apache/http/client/methods/HttpUriRequest;
astore 2
aload 0
aload 2
invokevirtual com/common/android/utils/http/HttpBaseClient/setupHTTPConnectionParams(Lorg/apache/http/client/methods/HttpUriRequest;)V
...
.method public httpUpImageRequest(Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;)Lcom/common/android/utils/http/Response;
.throws com/common/android/utils/http/HttpAuthException
.throws com/common/android/utils/http/HttpServerException
.throws com/common/android/utils/http/HttpException
...
aload 2
aload 5
invokevirtual com/common/android/utils/http/HttpBaseClient/createMethod(Ljava/lang/String;Ljava/net/URI;Lorg/apache/http/entity/mime/MultipartEntity;)Lorg/apache/http/client/methods/HttpUriRequest;
astore 2
aload 0
aload 2
invokevirtual com/common/android/utils/http/HttpBaseClient/setupHTTPConnectionParams(Lorg/apache/http/client/methods/HttpUriRequest;)V
...
.method protected prepareHttpClient()V
aload 0
new org/apache/http/impl/client/DefaultHttpClient
dup
invokespecial org/apache/http/impl/client/DefaultHttpClient/<init>()V
putfield com/common/android/utils/http/HttpBaseClient/mClient Lorg/apache/http/impl/client/DefaultHttpClient;
return
.limit locals 1
.limit stack 3
.end method
