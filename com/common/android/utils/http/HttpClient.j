.bytecode 50.0
.class public synchronized com/common/android/utils/http/HttpClient
.super com/common/android/utils/http/HttpBaseClient

.field private static final 'TAG' Ljava/lang/String; = "HttpClient"

.method public <init>()V
aload 0
invokespecial com/common/android/utils/http/HttpBaseClient/<init>()V
return
.limit locals 1
.limit stack 1
.end method
...
aload 0
iload 1
invokespecial com/common/android/utils/http/HttpBaseClient/<init>(I)V
return
.limit locals 2
.limit stack 2
.end method
...
aload 4
aload 5
invokespecial com/common/android/utils/http/HttpClient/createMultipartEntity(Ljava/lang/String;Ljava/io/File;Ljava/util/ArrayList;)Lorg/apache/http/entity/mime/MultipartEntity;
...
aload 0
aload 1
invokevirtual com/common/android/utils/http/HttpClient/createURI(Ljava/lang/String;)Ljava/net/URI;
astore 1
aconst_null
astore 9
aconst_null
...
aload 4
aload 5
invokevirtual com/common/android/utils/http/HttpClient/createMethod(Ljava/lang/String;Ljava/net/URI;Lorg/json/JSONObject;Ljava/io/File;Ljava/util/ArrayList;)Lorg/apache/http/client/methods/HttpUriRequest;
astore 2
aload 4
ifnull L17
aload 6
ifnull L17
aload 0
getfield com/common/android/utils/http/HttpClient/mClient Lorg/apache/http/impl/client/DefaultHttpClient;
aload 6
invokevirtual org/apache/http/impl/client/DefaultHttpClient/setCookieStore(Lorg/apache/http/client/CookieStore;)V
L17:
aload 0
aload 2
invokevirtual com/common/android/utils/http/HttpClient/setupHTTPConnectionParams(Lorg/apache/http/client/methods/HttpUriRequest;)V
aload 9
astore 1
L0:
aload 0
...
aload 2
aload 0
getfield com/common/android/utils/http/HttpClient/localcontext Lorg/apache/http/protocol/BasicHttpContext;
...
aload 2
invokevirtual com/common/android/utils/http/HttpClient/handleResponseStatusCode(ILcom/common/android/utils/http/Response;)V
aload 6
ifnull L20
aload 6
aload 0
