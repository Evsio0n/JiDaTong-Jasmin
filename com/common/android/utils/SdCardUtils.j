.bytecode 50.0
.class public synchronized com/common/android/utils/SdCardUtils
...
invokestatic com/common/android/utils/SdCardUtils/makesureFileSepInTheEnd(Ljava/lang/String;)Ljava/lang/String;
areturn
.limit locals 1
.limit stack 1
.end method
