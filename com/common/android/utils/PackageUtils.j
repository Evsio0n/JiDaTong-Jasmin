.bytecode 50.0
.class public synchronized com/common/android/utils/PackageUtils
...
aload 0
aload 1
invokestatic com/common/android/utils/PackageUtils/jumpActivity(Landroid/content/Context;Ljava/lang/String;)V
iconst_1
ireturn
L0:
iconst_0
