.bytecode 50.0
.class synchronized com/common/android/ui/viewPagerIndicator/TitlePageIndicatorExl$SavedState
...
.field public static final 'CREATOR' Landroid/os/Parcelable$Creator; signature "Landroid/os/Parcelable$Creator<Lcom/common/android/ui/viewPagerIndicator/TitlePageIndicatorExl$SavedState;>;"

.field 'currentPage' I

.method static <clinit>()V
new com/common/android/ui/viewPagerIndicator/TitlePageIndicatorExl$SavedState$1
dup
invokespecial com/common/android/ui/viewPagerIndicator/TitlePageIndicatorExl$SavedState$1/<init>()V
putstatic com/common/android/ui/viewPagerIndicator/TitlePageIndicatorExl$SavedState/CREATOR Landroid/os/Parcelable$Creator;
return
.limit locals 0
.limit stack 2
.end method
...
.method synthetic <init>(Landroid/os/Parcel;Lcom/common/android/ui/viewPagerIndicator/TitlePageIndicatorExl$1;)V
aload 0
aload 1
invokespecial com/common/android/ui/viewPagerIndicator/TitlePageIndicatorExl$SavedState/<init>(Landroid/os/Parcel;)V
return
.limit locals 3
.limit stack 2
.end method
