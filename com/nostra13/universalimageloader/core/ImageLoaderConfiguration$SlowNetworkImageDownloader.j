.bytecode 50.0
.class public synchronized com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader
...
getstatic com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/$SWITCH_TABLE$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme [I
astore 0
aload 0
ifnull L15
aload 0
...
L13:
aload 0
putstatic com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/$SWITCH_TABLE$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme [I
aload 0
areturn
L14:
astore 1
...
putfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/totalSizeMap Ljava/util/HashMap;
aload 0
new java/util/HashMap
dup
invokespecial java/util/HashMap/<init>()V
putfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/downloadSizeMap Ljava/util/HashMap;
aload 0
aload 1
putfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/wrappedDownloader Lcom/nostra13/universalimageloader/core/download/ImageDownloader;
return
.limit locals 2
.limit stack 3
.end method
...
lstore 2
aload 0
getfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/downloadSizeMap Ljava/util/HashMap;
ifnull L0
lload 4
lstore 2
aload 0
...
aload 0
getfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/wrappedDownloader Lcom/nostra13/universalimageloader/core/download/ImageDownloader;
aload 1
aload 2
aload 3
aload 4
...
astore 2
invokestatic com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/$SWITCH_TABLE$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme()[I
aload 1
...
areturn
L0:
new com/nostra13/universalimageloader/core/assist/FlushedInputStream
dup
aload 2
invokespecial com/nostra13/universalimageloader/core/assist/FlushedInputStream/<init>(Ljava/io/InputStream;)V
areturn
.limit locals 5
.limit stack 5
.end method
...
lstore 2
aload 0
getfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/totalSizeMap Ljava/util/HashMap;
ifnull L0
lload 4
lstore 2
aload 0
...
aload 0
getfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/writeLog Z
ireturn
.limit locals 1
.limit stack 1
.end method
...
aload 0
iload 1
putfield com/nostra13/universalimageloader/core/ImageLoaderConfiguration$SlowNetworkImageDownloader/writeLog Z
return
.limit locals 2
.limit stack 2
.end method
