.bytecode 50.0
.class public final synchronized com/nostra13/universalimageloader/core/assist/MemoryCacheUtil
...
new com/nostra13/universalimageloader/core/assist/MemoryCacheUtil$1
dup
invokespecial com/nostra13/universalimageloader/core/assist/MemoryCacheUtil$1/<init>()V
areturn
.limit locals 0
.limit stack 2
.end method
...
.method public static findCachedBitmapForImageUri(Ljava/lang/String;Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;)Landroid/graphics/Bitmap;
aload 1
invokeinterface com/nostra13/universalimageloader/cache/memory/MemoryCache/keys()Ljava/util/Collection; 0
invokeinterface java/util/Collection/iterator()Ljava/util/Iterator; 0
astore 2
