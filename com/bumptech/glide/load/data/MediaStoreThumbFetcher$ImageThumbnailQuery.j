.bytecode 50.0
.class synchronized com/bumptech/glide/load/data/MediaStoreThumbFetcher$ImageThumbnailQuery
...
ldc "_data"
aastore
putstatic com/bumptech/glide/load/data/MediaStoreThumbFetcher$ImageThumbnailQuery/PATH_PROJECTION [Ljava/lang/String;
return
.limit locals 0
.limit stack 4
.end method
...
getstatic com/bumptech/glide/load/data/MediaStoreThumbFetcher$ImageThumbnailQuery/PATH_PROJECTION [Ljava/lang/String;
ldc "kind = 1 AND image_id = ?"
iconst_1
anewarray java/lang/String
dup
iconst_0
