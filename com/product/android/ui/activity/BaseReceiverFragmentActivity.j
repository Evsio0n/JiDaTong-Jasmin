.bytecode 50.0
.class public synchronized com/product/android/ui/activity/BaseReceiverFragmentActivity
...
aload 0
aconst_null
putfield com/product/android/ui/activity/BaseReceiverFragmentActivity/baseMsgBroadCastReceiver Lcom/product/android/business/service/BaseMsgBroadCastReceiver;
aload 0
iconst_0
putfield com/product/android/ui/activity/BaseReceiverFragmentActivity/registerBroadCast Z
return
.limit locals 1
.limit stack 2
.end method
...
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_MyStatus()V
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_UserStatus()V
return
.limit locals 1
.limit stack 1
.end method
...
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_12000()V
return
.limit locals 2
.limit stack 1
.end method
...
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_UserStatus()V
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_AvatarChange()V
return
.limit locals 1
.limit stack 1
.end method
...
.method public handler_CMD_65060(Landroid/os/Bundle;)V
return
.limit locals 2
.limit stack 0
.end method
...
.method public handler_CMD_AvatarChange()V
return
.limit locals 1
.limit stack 0
.end method
...
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_GROUP_SYSMSG_TYPE_GROUP_INFO_CHANGED(Ljava/lang/String;)V
return
L0:
aload 0
ldc ""
...
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_x20004()V
return
.limit locals 2
.limit stack 1
.end method
...
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/unRegisterReceiverBroad()V
return
.limit locals 1
.limit stack 1
.end method
...
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/registerReceiverBroad()V
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_MyStatus()V
aload 0
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/handler_CMD_UserStatus()V
...
aload 0
getfield com/product/android/ui/activity/BaseReceiverFragmentActivity/registerBroadCast Z
ifne L0
aload 0
...
aload 0
aload 0
getfield com/product/android/ui/activity/BaseReceiverFragmentActivity/baseMsgBroadCastReceiver Lcom/product/android/business/service/BaseMsgBroadCastReceiver;
aload 1
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
pop
aload 0
iconst_1
putfield com/product/android/ui/activity/BaseReceiverFragmentActivity/registerBroadCast Z
...
aload 0
getfield com/product/android/ui/activity/BaseReceiverFragmentActivity/baseMsgBroadCastReceiver Lcom/product/android/business/service/BaseMsgBroadCastReceiver;
invokevirtual com/product/android/ui/activity/BaseReceiverFragmentActivity/unregisterReceiver(Landroid/content/BroadcastReceiver;)V
aload 0
iconst_0
putfield com/product/android/ui/activity/BaseReceiverFragmentActivity/registerBroadCast Z
L0:
